...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private int mBackgroundUnselectColor;
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mBackgroundSelectColor = ta.getColor(R.styleable.CommonTabLayout_tl_backgroundSelectColor, Color.parseColor("#00ffffff"));
        mBackgroundUnselectColor = ta.getColor(R.styleable.CommonTabLayout_tl_backgroundUnselectColor, Color.parseColor("#00ffffff"));
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            tabView.setBackgroundColor(i == mCurrentTab ? mBackgroundSelectColor : mBackgroundUnselectColor);
...
//            tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            tabView.setBackgroundColor(isSelect ? mBackgroundSelectColor : mBackgroundUnselectColor);
