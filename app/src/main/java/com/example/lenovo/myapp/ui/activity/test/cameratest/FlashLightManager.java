            ...
            private void _turnLightOnCamera2() {
                if (isLOLLIPOP()) {
                    ...
                    try {
                        ...
                        ToastMaster.toast("开启失败：" + e.getMessage());
                    }
                }
            }
        }._turnLightOnCamera2();
    ...
    private void turnLightOffCamera2() {
        new Object() {
            private void _turnLightOffCamera2() {
                if (cameraDevice != null && isLOLLIPOP()) {
                    cameraDevice.close();
                }
            }
            ...
            private void _initCamera2() {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    try {
                        ...
                        ToastMaster.toast("初始化失败：" + e.getMessage());
                    }
                }
            }
        }._initCamera2();
